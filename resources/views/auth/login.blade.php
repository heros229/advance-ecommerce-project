                    ...
                    <div class="col-md-6 col-sm-6 create-new-account">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="name" name="name" class="form-control unicase-form-control text-input" id="name" >
                            </div>
                            @error('name')
                                <span class="invalid-feedback" role="alert">
                                    <srtong style="color: red;" >{{ $message }}</srtong>
                                </span>
                            @enderror
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="phone" name="phone" class="form-control unicase-form-control text-input" id="phone" >
                            </div>
                            @error('phone')
                            <span class="invalid-feedback" role="alert">
                                    <srtong style="color: red;" >{{ $message }}</srtong>
